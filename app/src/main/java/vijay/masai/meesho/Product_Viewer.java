...
public class Product_Viewer extends AppCompatActivity implements ProductOnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Product_Viewer.this, MyOrdersActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Product_Viewer.this, firstPage.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void pageView() {
        String str = SharedPreferenceHelper.getStringPreference(Product_Viewer.this, "prodName");
    ...
    public void productOnClick(ProductRecyclerModel productRecyclerModel, int position) {
        ...
        SharedPreferenceHelper.writeIntegerPreference(Product_Viewer.this, "prodImgId", productRecyclerModel.getImgId());
        SharedPreferenceHelper.writeStringPreference(Product_Viewer.this, "prodNameId", productRecyclerModel.getProdName());
        SharedPreferenceHelper.writeIntegerPreference(Product_Viewer.this, "prodAmount", productRecyclerModel.getAmount());
        Intent intent = new Intent(Product_Viewer.this, View_Devices.class);
        startActivity(intent);
    }
}