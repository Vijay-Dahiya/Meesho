    ...
    private void initView() {
        ...
        ivMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(vijay.masai.meesho.firstPage.this, Product_Viewer.class);
        ...
        ivTablets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferenceHelper.writeStringPreference(vijay.masai.meesho.firstPage.this, "prodName", "Tablets");
                Intent intent = new Intent(vijay.masai.meesho.firstPage.this, Product_Viewer.class);
                startActivity(intent);
            }
        });
        ...
        ivCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(vijay.masai.meesho.firstPage.this, MyOrdersActivity.class);
                startActivity(intent);
            }
        });
